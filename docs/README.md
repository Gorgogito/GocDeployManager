...
- **[Documento de análisis](analisis-tecnico.html)** — análisis funcional/técnico previo a la implementación (Fase 0) y bitácora viva de decisiones arquitectónicas a lo largo de todas las fases.
